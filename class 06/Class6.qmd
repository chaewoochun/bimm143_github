...
change this to work with nucleotide  A C G and T
and return 3 of them
...
> **Key- Point**: Writing functions in R is doable but not the eaiset thing. Starting with a working snippet of code and then using LLM tools to improve generalize your function code is productive approach.
