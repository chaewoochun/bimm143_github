...
```
     ...
     [1] "C" "A" "T" "T" "C" "C" "C" "C" "G" "T" "T" "G" "A" "T" "C" "A" "T" "A" "G"
    [20] "T"
...
```
     ...
     [1] "A" "T" "T" "C" "C" "C" "A" "A" "G" "A" "T" "C" "A" "G" "G"
...
```
    ...
    [1] "AWYHS"        "ETTWPM"       "RVNKCEF"      "RIDYAAIS"     "SIRYEEKHR"   
    [6] "HGRVHWHREW"   "WRSGQRDQPRY"  "KTIQILIHQVCV"
